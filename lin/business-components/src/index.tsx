...
export type { ImageAdvertProps } from './components/image-advert';
export { default as ImageAdvert } from './components/image-advert';

export type { MagicCubeProps } from './components/magic-cube';
export { default as MagicCube } from './components/magic-cube';
