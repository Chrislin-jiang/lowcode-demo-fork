...
const productPath = `/business-components@${version}/build/docs/`;
...
export default defineConfig({
  ...
  chainWebpack(memo) {
    ...
    memo.resolve.alias.set('business-components', join(__dirname, '../src'));
  },
  ...
  alias: {
    ...
    'business-components': join(__dirname, '../src'),
  },
  apiParser: {
    propFilter: (prop) => {
